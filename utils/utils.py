...
def color_for_label(label):
    ...
    explainer_colors = ['tab:blue', 'tab:orange', 'tab:green', 'xkcd:crimson', 'tab:purple', 'tab:brown', 'tab:pink', 'tab:gray', 'tab:olive', 'tab:cyan', 'xkcd:indigo', 'xkcd:mint', 'xkcd:salmon', 'm']
    
    color_labels = dict(zip(explainer_labels, explainer_colors))
    
    #l = label.lower()
    if label in explainer_labels:
        return color_labels[label]
    else:
        return "#FFFFFF"
